    ...
    <header>
      ...
      <div id="headerMenu" className="z-10 flex justify-between fixed p-10 w-full bg-white sm:bg-transparent transition-all ease-in-out duration-500">
        ...
        <div id="logo" className="z-10">
          <NavLink to="/">
            <img src="../images/logo_determinant.png" alt="logo Determinant" className="w-2/4 sm:w-2/3 md:w-3/4 transition-all ease-in-out duration-500"/>
          </NavLink>
        </div>
        ...
        <div className="hidden md:block absolute z-10 top-0 right-0 p-10 font-primary" aria-label="dektop">
          <nav>
            <NavLink to="/metiers/" className="text-black pr-10">Nos métiers</NavLink>
            <NavLink to="/domaines/" className="text-black pr-10">Domaines d'interventions</NavLink>
            <NavLink to="/rd/" className="text-black pr-10">R&D</NavLink>
            <NavLink to="/process/" className="text-black pr-10">Nos process</NavLink>
            <NavLink to="/contact/" className="text-black">Contact</NavLink>
          </nav>
        </div>

        {/* BACKGROUND DU BANDEAU DU MENU */}
        <img src="../images/header_background_menu.png" alt="header footer" className="absolute top-0 left-0 w-full h-full"/>
      ...
      >
        <nav className="flex flex-col min-h-screen items-center py-8 m-auto w-2/3" aria-label="mobile">
          <NavLink to="/metiers/" className="hover:opacity:90 text-black w-full text-center py-6">Nos métiers</NavLink>
          <NavLink to="/domaines/" className="hover:opacity:90 text-black w-full text-center py-6">Domaines d'interventions</NavLink>
          <NavLink to="/rd/" className="hover:opacity:90 text-black w-full text-center py-6">R&D</NavLink>
          <NavLink to="/process/" className="hover:opacity:90 text-black w-full text-center py-6">Nos process</NavLink>
          <NavLink to="/contact/" className="hover:opacity:90 text-black w-full text-center py-6">Contact</NavLink>
        </nav>
      </div>
